...
export default function () {
  return (
    <div className="flex gap-6 p-2 w-[30vw] text-gray-800 border-t-2 border-r-2 border-gray-600" style={{background: 'linear-gradient(90deg, rgba(3,2,23,.2) 0%, rgba(31,31,98,.1) 100%)'
  }}>
